...
const About = () => {
  return (
    <div className="px-4 sm:px-[5vw] md:px-[7vh] lg:px-[9vh] ">
      ...
      {/* ----------------- About Us Section ----------------- */}
      <div className='text-2xl text-center pt-8 border-t mt-[100px]'>
      ...
      <div className='flex flex-col md:flex-row text-sm mb-20'>
          ...
          <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5 text-base text-center'>
            <b>Quality Assurance</b>
            <p className='text-gray-600 text-base'>Every item undergoes rigorous quality checks and material verification. We stand behind each product with confidence, ensuring premium craftsmanship in every piece we offer.</p>
          </div>

          <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5 text-base text-center'>
            <b>Convenience</b>
            <p className='text-gray-600 text-base'>Experience seamless shopping with smart filters, personalized recommendations, and express checkout. Your perfect outfit is just a few clicks away, delivered right to your doorstep.</p>
          </div>

          <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5 text-base text-center'>
            <b>Exceptional Customer Service</b>
            <p className='text-gray-600 text-base'>Our passionate style experts are available around the clock to help with sizing, styling advice, or any concern. Your complete satisfaction drives everything we do.</p>
          </div>
